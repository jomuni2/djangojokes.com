...
SECRET_KEY = 'django-insecure-!hjygu=f#$^z9*wf1+imn(htcbqfbhxw=r@l%g*az9*2un!#26'
...
DEFAULT_FROM_EMAIL = 'jeongeunlee@isu.edu'

# Password validation
# https://docs.djangoproject.com/en/5.1/ref/settings/#auth-password-validators

AUTHENTICATION_BACKENDS = (
    # Needed to log in by username in Django admin, even without 'allauth'
    'django.contrib.auth.backends.ModelBackend',

    # 'allauth'-specific auth methods, such as log in by email
